...
public class BatRotate : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (horiz != 0)
        {
            ...
            transform.Translate(-horiz * Mathf.Cos(zAngle * Mathf.PI / 180), -horiz * Mathf.Sin(zAngle * Mathf.PI / 180), 0);
        }
        //if (transform.position.x > 705)
        //{
        //    transform.position = new Vector3(705f, transform.position.y, transform.position.z);
        //}
        //if (transform.position.x < 690)
        //{
        //    transform.position = new Vector3(690f, transform.position.y, transform.position.z);
        //}
